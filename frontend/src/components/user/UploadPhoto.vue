<template>
  <div class="photo-upload">
    <div class="button-container">
      ...
      <button v-if="selectedFile" class="cancel-button" @click="cancelPreview">Відмінити</button>
    </div>
    <div class="move-photo" v-if="selectedFile">
      <img :src="selectedFilePreview" alt="Selected Photo" class="selected-photo" />
    </div>
    <button class="uploa-photo" v-if="selectedFile" @click="uploadPhoto">Завантажити фото</button>
  </div>
</template>
<script>
      ...
      onFileSelected(event) {
        try {
          ...
          if (error.message === 'Selected file is not an image') {
            errorMessage = 'Вибраний файл не є зображенням. Виберіть файл з розширенням .jpg, .png або .jpeg.';
          }
